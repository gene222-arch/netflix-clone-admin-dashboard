...
const MovieInputFields = ({ movie, setMovie, cardHeaderTitle, saveButtonCallback }) => 
{
    ...
    const handleChangeVideoFile = async (e) => 
    {
        ...
        try {
            ...
            dispatch(MOVIE_ACTION.updateMovieErrorState({ video_path: message.video ?? TITLE_IS_REQUIRED_FOR_FILE_UPLOAD_MESSAGE }))
        }
    ...
    const handleChangePosterFile = async (e) => 
    {
        ...
        try {
            ...
            dispatch(MOVIE_ACTION.updateMovieErrorState({ poster_path: message.poster ?? TITLE_IS_REQUIRED_FOR_FILE_UPLOAD_MESSAGE }))
        }
    ...
    const handleChangeWallpaperFile = async (e) => 
    {
        ...
        try {
            ...
            dispatch(MOVIE_ACTION.updateMovieErrorState({ wallpaper_path: message.wallpaper ?? TITLE_IS_REQUIRED_FOR_FILE_UPLOAD_MESSAGE }))
        }
    ...
    const handleChangeTitleLogoFile = async (e) => 
    {
        ...
        try {
            ...
            dispatch(MOVIE_ACTION.updateMovieErrorState({ title_logo_path: message.title_logo ?? TITLE_IS_REQUIRED_FOR_FILE_UPLOAD_MESSAGE}))
        }
